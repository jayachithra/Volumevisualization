...
public class TransferFunction2DEditor extends javax.swing.JPanel {
    ...
    public double minGradientMagnitude;
    ...
    public TransferFunction2DEditor(Volume volume, GradientVolume gradientvolume) {
        ...
        triangleWidget = new TriangleWidget((short) (maxIntensity / 2), 0.2, maxGradientMagnitude);
        setSelectedInfo();
    }
    ...
    public void setSelectedInfo() {
        ...
        minMagnitudeLabel.setText(String.format("%.1f", triangleWidget.minGradient));
        maxMagnitudeLabel.setText(String.format("%.1f", triangleWidget.maxGradient));
        baseMagnitudeLabel.setText(String.format("%.1f", triangleWidget.baseGradient));
    }
    ...
    private void initComponents() {
        ...
        minMagnitudeLabel = new javax.swing.JTextField();
        maxMagnitudeLabel = new javax.swing.JTextField();
        baseMagnitudeLabel = new javax.swing.JTextField();
        ...
        jLabel8.setText("Min magnitude");

        jLabel9.setText("Max magnitude");

        jLabel10.setText("Base magnitude");

        minMagnitudeLabel.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                minMagnitudeLabelActionPerformed(evt);
            }
        });

        maxMagnitudeLabel.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                maxMagnitudeLabelActionPerformed(evt);
            }
        });
                                    ...
                                    .addGroup(layout.createSequentialGroup()
                                        ...
                                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                                .addComponent(maxMagnitudeLabel, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 81, Short.MAX_VALUE)
                                                .addComponent(baseMagnitudeLabel, javax.swing.GroupLayout.Alignment.LEADING))
                                            .addComponent(minMagnitudeLabel, javax.swing.GroupLayout.PREFERRED_SIZE, 81, javax.swing.GroupLayout.PREFERRED_SIZE))
                                        .addGap(0, 0, Short.MAX_VALUE)))
                                .addContainerGap())))
                    .addGroup(layout.createSequentialGroup()
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            .addComponent(jLabel8)
                            .addComponent(minMagnitudeLabel, javax.swing.GroupLayout.PREFERRED_SIZE, 27, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            .addComponent(jLabel9)
                            .addComponent(maxMagnitudeLabel, javax.swing.GroupLayout.PREFERRED_SIZE, 27, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            .addComponent(jLabel10, javax.swing.GroupLayout.PREFERRED_SIZE, 20, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(baseMagnitudeLabel, javax.swing.GroupLayout.PREFERRED_SIZE, 27, javax.swing.GroupLayout.PREFERRED_SIZE))))
    ...
    private void minMagnitudeLabelActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_minMagnitudeLabelActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_minMagnitudeLabelActionPerformed
    ...
    private void maxMagnitudeLabelActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_maxMagnitudeLabelActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_maxMagnitudeLabelActionPerformed
    ...
    public class TriangleWidget {
        ...
        public double baseGradient;

        public TriangleWidget(short base, double r, double m) {
            this.baseIntensity = base;
            this.radius = r;
            this.color = new TFColor(0.0, 204.0/255.0, 153.0/255.0, 0.3);
            this.minGradient = m / 10;
            this.maxGradient = m;
            this.baseGradient = 0.0;
        }
    }

    // Variables declaration - do not modify//GEN-BEGIN:variables
    private javax.swing.JTextField baseMagnitudeLabel;
    ...
    private javax.swing.JTextField maxMagnitudeLabel;
    private javax.swing.JTextField minMagnitudeLabel;
